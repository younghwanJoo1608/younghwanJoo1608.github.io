...
3. $U_{K}$를 대한민국을 이루는 3요소들의 set,<sup id="fnref:2"><a href="#fn:2" rel="footnote">2</a></sup> $\\{\textrm{국민, 영토, 주권}\\}$,<br/> $U_{p}$를 대한민국의 모든 국민들의 set이라고 하자. 그러면 \\[ \textrm{박지훈} \in U_{p} \in U_{K} \\] 그러나 \\[ \textrm{박지훈} \notin U_{K} \\]이므로, $U_{p} \not\subseteq U_{K}$.
...
<div markdown = "1" class="footnotes"><ol>
  ...
  <li class="footnote" id="fn:2">
    <p>$\\{$국민, 영토, 주권$\\}$<a href="#fnref:2" title=""> ↩</a><p> 
