...
이제 $F$가 $G \\wedge H$ 형태라고 하자. 그러면 [Substitution(Theorem 1.5.4)](https://pyohyu1608.tistory.com/7#1.5.4)에 의해 $F \\equiv G\_1 \\wedge H\_1$. $G\_1$과 $H\_1$은 CNF이므로, 그 conjunction도 CNF.
