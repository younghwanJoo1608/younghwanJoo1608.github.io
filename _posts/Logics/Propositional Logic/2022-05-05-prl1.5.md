...
[Double negation](https://younghwanjoo16081608.tistory.com/6#t1.4.1)에 의해, $\\neg(\\bigvee\_{i=1}^{n} F\_{i}) \\equiv (\\bigwedge\_{i=1}^{n} \\neg F\_{i})$. $\\square$
...
이제 $H$와 $H'$이 provably equivalent가 되는 5가지 경우를 모두 입증하면 된다. [Section 1.4의 Table](https://younghwanjoo16081608.tistory.com/6#t1.4.1)을 이용하자.\[footnote\]Theorem 1.5.4와는 달리, 여기서는 의미론(semantics)를 사용했음에 유의.\[/footnote\] $\\square$
