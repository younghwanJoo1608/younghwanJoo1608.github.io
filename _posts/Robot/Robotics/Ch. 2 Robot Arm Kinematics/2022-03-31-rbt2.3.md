...
<p align="center"><img src="/assets/image/robotics/ch2/2.14.jpg" width="50%" height="50%" title="" alt=""><br/></p>
...
<p align="center"><img src="/assets/image/robotics/ch2/2.15.jpg" width="50%" height="50%" title="" alt=""><br/></p>
...
Configuration space $\mathcal{C} \subset \mathbb{R}^N$는 모든 가능한 configuration $\textrm{q}$의 space.

$$
\textrm{q} = \{q_j \ |\ j \in [1 \cdots N] \} \in \mathcal{C}
$$
