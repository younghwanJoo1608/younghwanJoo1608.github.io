...
<p align="center"><img src="/assets/image/robotics/ch2/2.8." width="" height="" title="" alt=""><br/></p>
...
<p align="center"><img src="/assets/image/robotics/ch2/2.9." width="" height="" title="" alt=""><br/></p>

이전 link frame에 대한 다음 link frame의 pose는

$$
{}^{j-1}\textrm{T}_j = \textrm{R}_z(\theta_j) \textrm{T}_z(d_j) \textrm{T}_x(a_j) \textrm{R}_x(\alpha_j)
$$
...
$$
\textrm{T}_E = {}^{0}\textrm{T}_1(\theta_1){}^{1}\textrm{T}_2(\theta_2) \cdots {}^{N-1}\textrm{T}_N(\theta_N)
$$

Prismatic joint가 섞여 있으면(RPRRRR),

$$
\textrm{T}_E = {}^{0}\textrm{T}_1(\theta_1){}^{1}\textrm{T}_2(d_2) \cdots {}^{N-1}\textrm{T}_N(\theta_N)
$$
...
<p align="center"><img src="/assets/image/robotics/ch2/2.10." width="" height="" title="" alt=""><br/></p>
...
<p align="center"><img src="/assets/image/robotics/ch2/2.11.png" width="50%" height="50%" title="" alt=""><br/></p>
...
<p align="center"><img src="/assets/image/robotics/ch2/2.12." width="" height="" title="" alt=""><br/></p>
